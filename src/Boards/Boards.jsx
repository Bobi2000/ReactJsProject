...
function Boards({ isLogged }) {
    return <div className="column side">
        <div className="new-discussion-box box">
            {isLogged && <a href="/create-post" className="create-discussion-cta button"><span>Create a Discussion</span></a>}
                ...
                <div>
                    <div id="markdown-nav" className="markdown-nav apollo markdown-content">
                        <p>
                            <strong>Game</strong>
                            <br />
                            <a href="/champions" className="safe">Champions</a>
                            <br />
                            <a href="/creation-concepts" className="safe">CreationConcepts</a>
                            <br />
                            <a href="/off-topic" className="safe">OffTopic</a>
                            <br />
                            <a href="/streams-videos" className="safe">StreamsVideos</a>
                        </p>
                    </div>
                </div>
            </div>
